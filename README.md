...
| **ИТОГО (1 язык + картинки)** | | **~$3.55** | **~$3.50** |
| **ИТОГО (9 языков, без картинок)** | | **~$4.00** | **~$3.45** |
...
| Провайдер | Модель | Цена за 1M токенов (вход+выход) | Примерно для 9 языков |
|-----------|--------|--------------------------------|----------------------|
| OpenAI | gpt-4o-mini | ~$0.30 | ~$0.99 |
| Anthropic | claude-haiku-4-5 | ~$1.50 | ~$5.00 |
| Anthropic | claude-sonnet-4-6 | ~$6.00 | ~$20.00 |

> Batch API (−50%) доступен только для OpenAI. При смене провайдера на Claude/Google кнопка Batch исчезает.
...
| 🔜 8 | Ридер: отображение chapter_N.jpg перед главами. GitHub autopush. |
